    ...
    <section class="content">
              ...
              <div class="box box-primary">
                    <div class="box-header with-border" >
                      ...
                      <form class="contact100-form validate-form" enctype="multipart/form-data" action="{{ route('admin.mediaeditar.store') }} " method="post"  id="avatarForm">
                      ...
                      {!! Form::token() !!}
                        ...
                        <h3 class="box-title" align="center">Editar Media</h3>

                        <hr>
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input101" data-validate="">
                                <span class="label-input100"><h5>Titulo del Media<h5></span>
                      ...
                      <div class="wrap-input100 bg1 ">
                       ...
                       <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Please Type Your Message">
                          <span class="label-input100"><h5>Describir la media</h5></span>
                          <br>
